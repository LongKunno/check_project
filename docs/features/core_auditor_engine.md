...
### 5. Tính Điểm & Chấm Hạng Phân Cấp (Aggregation)
Cuối cùng, các vi phạm đọng lại sau nhiều lần bộ lọc (AI) sẽ tiến vào Máy đo lường Điểm Số:
- Tính điểm Phân cấp (Feature-based Scoring): Quy đổ thành Điểm Số Bằng Số cho Từng Tính Năng để xem khu vực nào Nợ lớn nhất (Technical Debt). Tích hợp cấu trúc Phạt Nặng/Nhẹ.
