...
- Chỉ đánh giá mã nguồn được viết trong **3 tháng gần nhất** (sử dụng `git blame --since="3 months"`). Lỗi trên code cũ sẽ được bỏ qua cho member nhưng vẫn tính cho toàn dự án.
