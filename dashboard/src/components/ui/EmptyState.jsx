...
export default function EmptyState({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-${accentColor}-500/5 blur-[80px] rounded-full pointer-events-none`}
      />
      ...
      >
        <div
          className={`inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-${accentColor}-500/10 border border-${accentColor}-500/20`}
        >
