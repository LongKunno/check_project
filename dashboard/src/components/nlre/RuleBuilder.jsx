...
const StreamingTerminal = ({ text, isPending, label }) => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#060a10] border border-white/8 rounded-2xl overflow-hidden shadow-inner max-w-4xl mx-auto w-full">
      {/* Terminal header */}
  ...
  return (
    <div className="flex-1 flex flex-col w-full bg-transparent pt-0 pb-12 gap-5 font-sans relative">
      ...
      <div className="flex-1 w-full relative z-10 flex flex-col gap-5 max-w-7xl mx-auto h-[calc(100vh-160px)]">
        {/* ── Stepper ── */}
        <div className="bg-[#080c14]/80 backdrop-blur-xl border border-white/[0.07] rounded-2xl px-8 py-5 shrink-0 shadow-lg">
          <Stepper current={wizardStep} />
        </div>

        {/* ── Main panel ── */}
        <div className="flex-1 bg-[#080c14]/80 backdrop-blur-xl border border-white/[0.07] rounded-2xl shadow-2xl relative overflow-hidden flex flex-col min-h-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 flex-1 min-h-0">
                  ...
                  <div className="flex flex-col min-h-0">
                    ...
                    <textarea
                      ...
                      className={cn(
                        "flex-1 min-h-[200px] bg-black/40 border rounded-2xl p-5 text-slate-100 font-medium",
                  ...
                  <div className="flex flex-col bg-black/20 rounded-2xl border border-white/5 overflow-hidden min-h-0">
                                ...
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    isSelected
                                      ...
                                      : "bg-black/30 border-white/5 hover:border-violet-500/30 hover:bg-violet-900/10",
                                  )}
                                >
                                  <div
                                    className={cn(
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5 shrink-0">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="p-2 bg-black/40 hover:bg-white/10 border border-white/8 rounded-xl text-slate-400 hover:text-white transition-colors"
                    >
                      <ChevronLeft size={18} />
                    </button>
                    <div>
                ...
                {isCompiling || isAutoFixing ? (
                  ...
                  <motion.div
                    ...
                    className="flex-1 max-w-2xl mx-auto w-full bg-[#0d1117] border border-amber-500/30 rounded-2xl flex flex-col items-center justify-center text-center relative overflow-hidden shadow-2xl p-10"
                  >
                  ...
                  >
                    <div className="flex justify-between items-center bg-black/60 border-b border-emerald-500/20 py-3 px-5 shrink-0">
                  ...
                  <div className="flex-1 flex items-center justify-center text-slate-600 gap-3 bg-black/20 rounded-2xl border border-dashed border-white/5">
            ...
            {wizardStep === 3 && (
              ...
              >
                ...
                <div className="flex-1 flex gap-4 min-h-0">
                  {/* Left: JSON editor */}
                  <div className="w-[38%] flex flex-col bg-[#060a10] border border-white/8 rounded-2xl overflow-hidden focus-within:border-violet-500/40 transition-colors">
                    <div className="flex items-center justify-between bg-black/60 border-b border-white/5 py-2.5 px-4 shrink-0">
                  ...
                  <div className="flex-1 flex flex-col gap-3 min-h-0">
                    {/* Code input */}
                    <div className="flex-1 flex flex-col bg-[#060a10] border border-white/8 rounded-2xl overflow-hidden focus-within:border-blue-500/40 transition-colors min-h-0">
                      <div className="flex items-center bg-black/60 border-b border-white/5 py-2.5 px-4 shrink-0">
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-1.5">
                    ...
                    {/* Results */}
                    <div className="flex-1 flex flex-col bg-[#060a10] border border-white/8 rounded-2xl overflow-hidden min-h-0">
                      <div className="flex items-center justify-between bg-black/60 border-b border-white/5 py-2.5 px-4 shrink-0">
                        <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-1.5">
